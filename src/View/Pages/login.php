			...
			<div class="row justify-content-center">
				<div class="col-md-12 col-lg-10">
					<div class="wrap d-md-flex">
						<div class="img" style="background-image: url(assets/img/hero-img.png);">
			      </div>
						<div class="login-wrap p-4 p-md-5">
			      	<div class="d-flex">
			      		<div class="w-100">
			      			<h3 class="mb-4">Sign In</h3>
							  <?php if(isset($_SESSION['error']) && $_SESSION['error'] == "pasbon")
                    				echo "<span style='color:red;'>Username or password wrong.</span>";
         					   ?>
			      		</div>
								
			      	</div>
							<form action="/archiweb_2024_projets_gr02-main/webapp/loginSubmit" class="signin-form" method="POST">
